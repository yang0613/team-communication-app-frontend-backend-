...
DELETE FROM message;
--CSE 183--
INSERT INTO message(message_id, channel_id, message) VALUES ('5aecd140-eab0-11eb-9a03-0242ac130003','09186a40-4b16-4051-a8c9-07a644e72f6f','{"name":"Bob Dylan"}, {"time": "Friday, July 9"}, {"text": "How many roads must a man walk down?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('29a1a19b-55f5-4f87-823a-c13cbbb80d96','30a614a1-f540-40af-9313-020f4ab4a7f9','{"name":"Logan Thompson"}, {"time": "Saturday, July 10"}, {"text": "I hope I get this assignment done in time."}');
INSERT INTO message(message_id, channel_id, message) VALUES ('4ca0809d-1d68-41b8-924f-97aaecc27dfb','e690d1c3-5042-494e-bcbe-42bd9a6b9adb','{"name":"Jessica Higgins"}, {"time": "Sunday, July 11"}, {"text": "I hope you had fun at the park."}');
INSERT INTO message(message_id, channel_id, message) VALUES ('2db3631d-0be1-4cc6-86b5-03d2733cd332','2e6478bc-cecc-4dea-9cf2-433027d4f145','{"name":"Dr Harrison"}, {"time": "Monday, July 12"}, {"text": "If this assignment is late, you get an F"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('4c46e3e8-8783-472f-accf-285dac9c905e','d4c3bfcf-d799-4d55-bbd9-9a8eb43db377','{"name":"Carl Carlson"}, {"time": "Tuesday, July 13"}, {"text": "What classes are you taking?"}');
--CSE 140--
INSERT INTO message(message_id, channel_id, message) VALUES ('a10199ce-7812-4391-a2db-810d50feb7a13','ed503c47-bca9-4c3d-ae9c-38113d309580','{"name":"Meek Mill"}, {"time": "Friday, July 9"}, {"text": "Are you living on campus?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('11e1611c-90f7-49e9-9527-eb2ace8c38cb','88c95ea7-9dd5-4d61-9fb6-c8dd75c1afcb','{"name":"Rick Sanchez"}, {"time": "Saturday, July 10"}, {"text": "Do you watch Rick and Morty?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('2083a12c-bb28-438b-8cf3-915cb814fc92','d1946786-f2a9-4101-aa6e-bc1d78c17a73','{"name":"Logan Thompson"}, {"time": "Sunday, July 11"}, {"text": "Is anyone else taking CSE183 right now?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('0b9c28bf-1bd1-426b-b6c3-c31762d905ad','0730b5f9-759f-4a9a-9e89-a923646183fb','{"name":"Rachel Munn"}, {"time": "Monday, July 12"}, {"text": "Does anyone know how to do number two?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('cd37d3d4-ac9d-4274-ba9c-56438f97b444','8ae7934a-b4ec-46f4-ba97-73bcc7fc43f1','{"name":"Dayton Oldham"}, {"time": "Tuesday, July 13"}, {"text": "Anyone down to go to a party?"}');
--CSE 101--
INSERT INTO message(message_id, channel_id, message) VALUES ('f970246b-2eec-4142-81f9-5204725f0e0f','d2f55f30-28f8-4859-90df-ed376fd3bad1','{"name":"Ian Collis"}, {"time": "Friday, July 9"}, {"text": "When is the next quiz?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('540ad403-1ec6-4a87-a3eb-da2a96390179','3031f349-5a0d-4a17-819b-1a8df32d0c38','{"name":"Maurissa Brown"}, {"time": "Saturday, July 10"}, {"text": "Has anyone taken Dr. Harrison?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('c05142d6-5725-403c-ab9c-f3d8ef4d1e27','b99b15b8-a4d6-4a93-8946-3d2247ac7cab','{"name":"Mario Moreno"}, {"time": "Sunday, July 11"}, {"text": "When is the next office hours?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('eafccf04-f45d-4038-a96c-2c1aa62c538a','c8a266e8-42d2-4fea-a910-72eabda35324','{"name":"Karina Nolasco"}, {"time": "Monday, July 12"}, {"text": "What was the answer to the last question on the test?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('abbe91a0-7029-4b24-9915-1be7e0212ab8','13217716-6018-4239-88f7-a41ff81cf8f8','{"name":"Justin Singh"}, {"time": "Tuesday, July 13"}, {"text": "I cant wait until summer vacation."}');
--CSE 102--
INSERT INTO message(message_id, channel_id, message) VALUES ('f970246b-2eec-4142-81f9-5204725f0e0f','d2f55f30-28f8-4859-90df-ed376fd3bad1','{"name":"Cade Brecht"}, {"time": "Friday, July 9"}, {"text": "What is this class about?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('540ad403-1ec6-4a87-a3eb-da2a96390179','3031f349-5a0d-4a17-819b-1a8df32d0c38','{"name":"Brandon Faulks"}, {"time": "Saturday, July 10"}, {"text": "Does anyone know where to find the syllabus?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('c05142d6-5725-403c-ab9c-f3d8ef4d1e27','b99b15b8-a4d6-4a93-8946-3d2247ac7cab','{"name":"Liam Smoody"}, {"time": "Sunday, July 11"}, {"text": "Is attendence mandatory?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('eafccf04-f45d-4038-a96c-2c1aa62c538a','c8a266e8-42d2-4fea-a910-72eabda35324','{"name":"Zach Paxton"}, {"time": "Monday, July 12"}, {"text": "Did you do the extra credit?"}');
INSERT INTO message(message_id, channel_id, message) VALUES ('abbe91a0-7029-4b24-9915-1be7e0212ab8','13217716-6018-4239-88f7-a41ff81cf8f8','{"name":"Josh Hofman"}, {"time": "Tuesday, July 13"}, {"text": "Where can I find a UUID generator?"}');
